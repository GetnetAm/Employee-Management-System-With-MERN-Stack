...
export const DepartmenuButtons=({DepId, onDepartmentDelete})=>{
    ...
    const handleDelete=async()=>{
        ...
        try {
            const response= await axios.delete(`http://localhost:5000/api/department/delete/${DepId}`, {
                headers:{
    ...
    return(
        <div className="flex space-x-3">
            ...
            <button className="px-3 py-1 bg-red-600 text-white" onClick={handleDelete}>Delete</button>
        </div>
    )
}
